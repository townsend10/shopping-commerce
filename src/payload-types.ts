...
export interface Tenant {
  ...
  name: string;
  /**
   * subdomain like "[slug].store.com"
   */
  slug: string;
  image?: (string | null) | Media;
  /**
   * Stripe accouunt ID associated with your shop.
   */
...
/**
 * You must verifiy your account before creating products
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Order {
  ...
  /**
   * Stripe checkout session associeted with the order
   */
  stripeCheckoutSessionId: string;
  /**
   * Stripe account associeted with the order
   */
